...
4. Recopiez la même entrée dans le bloc `var REGISTRY = …` d'**`index.html`**
   (entre `/* REGISTRY-START */` et `/* REGISTRY-END */`) — c'est lui qui
   permet au site de marcher même ouvert en double-clic (un test pytest
