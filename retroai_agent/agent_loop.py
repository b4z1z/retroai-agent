...
AIDE_LOGICIEL = (
    ...
    "TO the marketplace (the OWNER — recognized by his git identity — "
    "publishes directly: registry + site updated, commit+push, the Vercel "
    "site auto-deploys in ~30s ; anyone ELSE is guided to open a GitHub "
    ...
    "installed plugins, remembered facts, activity period. No telemetry — "
